...
#' @usage splitTS ( fileTS = NULL, yearStart = NULL, yearEnd = NULL, nameColumnDate = NULL,
#' typeInterval = c("annual","cropYear","myInterval"), sameYear = TRUE,
#' monthStart = 01, monthEnd = 12 )
#' @param fileTS file time series
#' @param yearStart number integer of the year starts time series, i.e, 2001
#' @param yearEnd number integer of the year ends time series, i.e, 2005
#' @param nameColumnDate name of column with value of date in data.frame
...
#' @param monthStart number integer defining the month starts to split, only if typeInterval is choose. Default is 1, January.
#' @param monthEnd number integer defining the month ends to split, only if typeInterval is choose. Default is 12, December.
#' @keywords features extraction, time series, split data.frame in years
#' @return news data.frame with data.frame input splited
#' @examples
#' # open a data example
#' library(featuresTS)
...
#' splitTS(df,2002,2005,"date",typeInterval = "myInterval", sameYear = FALSE, monthStart = 08, monthEnd = 03)
